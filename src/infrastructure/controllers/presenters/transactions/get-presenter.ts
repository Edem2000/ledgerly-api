...
import { TransactionPresenter, TransactionResponseDto } from 'infrastructure/controllers/presenters/_common/transaction-presenter';
...
export class GetTransactionsPresenter{
  static present(transactions: Transaction[], page: number, limit: number, total: number): GetTransactionsResponseDto {
    return {
      success: true,
      page,
      limit,
...
export type GetTransactionsResponseDto = ({
  success: boolean,
} & PaginatedResponseDto<TransactionResponseDto>)| ErrorDto;