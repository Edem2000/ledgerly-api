...
import { GetTransactionsPresenter, GetTransactionsResponseDto } from 'infrastructure/controllers/presenters/transactions/get-presenter';
import { DeleteTransactionPresenter, DeleteTransactionResponseDto } from 'infrastructure/controllers/presenters/transactions/delete-presenter';
...
export class TransactionController {
    ...
    public async create(
        @Body() params: CreateTransactionDto,
    ...
    public async get(@Query() query: GetTransactionsQueryDto): Promise<GetTransactionsResponseDto> {
      try {
        ...
        const { transactions, page, limit, total } = await this.getTransactionsUsecase.execute(params, currentUser, context);
