...
@Module({
    imports: [UserModule, CurrentUserModule, AuthModule, RoleModule, AuditLogModule],
    providers: [
        {
        ...
        },
        {
            ...
            useFactory(userService: UserService, roleService: RoleService): GetUsersUsecase {
                return new GetUsersUsecaseImpl(userService, roleService);
            },
            inject: [Symbols.domain.user.userService, Symbols.domain.role.roleService],
        },
        {
            provide: Symbols.usecases.users.search,
            useFactory(userService: UserService, roleService: RoleService): SearchUsersUsecase {
        ...
        },
        {
            ...
            useFactory(userService: UserService, roleService: RoleService): GetUserUsecase {
        ...
        },
        {
            ...
            useFactory(userService: UserService, auditLogService: AuditLogService): DeleteUserUsecase {
                return new DeleteUserUsecaseImpl(userService, auditLogService);
            },
            inject: [Symbols.domain.user.userService, Symbols.domain.auditLog.auditLogService],
        },
        {
