...
export const categoryByType: Record<AuditType, AuditCategory> = {
    ...
    [AuditType.TransactionCreate]: AuditCategory.Transaction,
    [AuditType.TransactionUpdate]: AuditCategory.Transaction,
    [AuditType.TransactionDelete]: AuditCategory.Transaction,
};
...
export const messageByType: Record<AuditType, MultiLanguage> = {
    ...
    [AuditType.TransactionCreate]: {
        ru: 'Транзакция успешно создана',
        uz: 'Tranzaksiya muvaffaqiyatli yaratildi',
        en: 'Transaction created successfully',
    },
    [AuditType.TransactionUpdate]: {
        ru: 'Транзакция успешно обновлена',
        uz: 'Tranzaksiya muvaffaqiyatli yangilandi',
        en: 'Transaction updated successfully',
    },
    [AuditType.TransactionDelete]: {
        ru: 'Транзакция успешно удалена',
        uz: "Tranzaksiya muvaffaqiyatli o'chirildi",
