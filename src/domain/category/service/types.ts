...
export type CreateParams = Omit<CategoryModel, 'deleted' | 'status' | 'usageCount'>;
export type UpdateParams = DeepPartial<Omit<CategoryModel, 'userId' | 'status' | 'deleted' | 'deletedAt'>>;
