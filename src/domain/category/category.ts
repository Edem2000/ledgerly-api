...
export class Category extends BaseEntity<CategoryModel> {
    ...
    public get usageCount(): number {
        return this.model.usageCount;
    }

    public set usageCount(value: number) {
        this.model.usageCount = value;
    }

    public get lastUsedAt(): Date | undefined {
        return this.model.lastUsedAt;
    }

    public set lastUsedAt(value: Date | undefined) {
        this.model.lastUsedAt = value;
    }
}
